...
public class ExportServiceImpl implements ExportService {
    ...
    // Reads every expense record, formats the rows as CSV, and returns the generated bytes.
    @Override
    ...
    // Escapes double quotes so text values stay valid inside quoted CSV columns.
